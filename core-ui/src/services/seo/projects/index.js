    ...
    list: [
      {
        ...
        actions: [
          {
            label: "Setup Guide",
            href: "https://github.com/itsrighttime/vps-deployment-platform",
          },
        ],
        description:
    ...
    list: [
      {
        ...
        actions: [
          {
            label: "Source Code",
            href: "https://github.com/itsrighttime/socket-io",
          },
        ],
        description:
      ...
      },
      {
        ...
        actions: [
          {
            label: "Source Code",
            href: "https://github.com/itsrighttime/utils",
          },
        ],
        description:
      ...
      },
      {
        ...
        actions: [
          {
            label: "Source Code",
            href: "https://github.com/itsrighttime/broadcast",
          },
        ],
        description:
      ...
      },
      {
        ...
        actions: [
          {
            label: "Source Code",
            href: "https://github.com/itsrighttime/ui-components",
          },
        ],
        description:
    ...
    list: [
      {
        ...
        actions: [
          {
            label: "Website",
            href: "https://itsrighttime.group/",
          },
          {
            label: "UI Source Code",
            href: "https://github.com/itsrighttime/itsrighttime_ui",
          },
          {
            label: "Server Source Code",
            href: "https://github.com/itsrighttime/itsrighttime_server",
          },
        ],
        description:
      ...
      },
      {
        ...
        actions: [
          {
            label: "Website",
            href: "https://cre.itsrighttime.group/",
          },
          {
            label: "UI Source Code",
            href: "https://github.com/itsrighttime/creative_ui",
          },
          {
            label: "Server Source Code",
            href: "https://github.com/itsrighttime/creative_server",
          },
        ],
        description:
